...
- Demo data: `bun scripts/seed-hubspot-demo.ts` in `apps/api` seeds the HubSpot rollout demo (initiative, theses, two indexed documents) into production through the API. Idempotent. `FT_API_BASE=http://localhost:8787` targets local.
